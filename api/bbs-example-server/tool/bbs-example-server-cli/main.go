...
import (
	"BBS-Example/api/bbs-example-server/client"
	"BBS-Example/api/bbs-example-server/tool/cli"
	"fmt"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "bbs-example-server-cli",
		Short: `CLI client for the bbs-example-server service`,
	}
	...
	c.UserAgent = "bbs-example-server-cli/0"
